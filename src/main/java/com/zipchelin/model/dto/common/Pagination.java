...
public class Pagination {
    ...
    public Pagination(int totalRecordCount, QnaDto params) {
    ...
    public Pagination(int totalRecordCount, MyrecipeDto params) {
    	if (totalRecordCount > 0) {
            this.totalRecordCount = totalRecordCount;
            calculation(params);
        }
	...
	private void calculation(MyrecipeDto params) {
		 // 전체 페이지 수 계산
