                    ...
                    <div class="card-body">
                        <form method="post" action="updateGuide" class="noticeList">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" class="form-control" id="recNum" name="recNum" value="1"
                                           disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file mb-2">
                                    <input type="file" id="recImg0" name="recImg0" class="custom-file-input"
                            ...
                            <div class="form-group">
                                ...
                                <div class="guiStep pt-3 pb-3">
                                    ...
                                    <div class="custom-file mb-2">
                                        <input type="file" class="custom-file-input" id="recImg1" name="recImg1"
                                               aria-describedby="recImg1">
                                ...
                                <div class="guiStep pt-3 pb-3">
                                    ...
                                    <div class="custom-file mb-2">
                                        <input type="file" class="custom-file-input" id="recImg2" name="recImg2"
                                               aria-describedby="recImg2">
                                        <label class="custom-file-label" for="recImg1">이미지파일</label>
                                    </div>
                                ...
                                <div class="guiStep pt-3 pb-3">
                                    ...
                                    <div class="custom-file mb-2">
                                        <input type="file" class="custom-file-input" id="recImg3" name="recImg3"
                                               aria-describedby="recImg3">
                                        <label class="custom-file-label" for="recImg1">이미지파일</label>
                                    </div>
                            ...
                            <div class="d-flex justify-content-end mb-2">
                                <button type="reset" class="btn btn-secondary mr-2"
                                        onClick="location.href='${contextPath}/admin/recipe'">취소
                                </button>
                                <button type="submit" class="cancle_check btn btn-primary">등록</button>
                            </div>
                        </form>
                    </div>
                </div>
