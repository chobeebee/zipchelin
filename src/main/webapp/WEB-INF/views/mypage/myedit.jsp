        ...
        <form id="edit_form" action="/mypage/memberUpdate" method="post">
            ...
            <div class="profile_section clearfix">
                ...
                <div class="profile_edit_btn">
                    ...
                    <input type="button" value="기본 이미지로 변경" class="profile_change_btn profile_btn btnBdGray"
                           onclick="loaction.href='#'">
                </div>
            </div>
            ...
            <div class="edit_info_id ">
                <div class="edit_form_item">
                    ...
                    <div class="edit_info_input">
                        <input type="text" id="id" class="edit_input edit_input2" name="id" placeholder="USER_ID"
            ...
            <div class="edit_form_item">
                ...
                <div class="inputField edit_info_input">
                    <input type="password" id="edit_pwd" class="edit_input edit_input2" name="pwd"
            ...
            <div class="edit_form_item">
                ...
                <div class="inputField edit_info_input">
                    <input type="password" id="check_pwd" class="edit_input edit_input2" name="pwdCheck"
                           placeholder="특수문자/영문자/숫자 포함 8~15자">
                    <span class="edit_pwdToggle pwdToggle material-symbols-outlined">visibility_off</span>
            ...
            <div class="edit_form_item">
                ...
                <div class="edit_info_input">
                    <input type="text" id="name_input" class="edit_input edit_input2" name="name"
                           value="${member.memberName}" placeholder="이름">
            ...
            <div class="form_item edit_form_email edit_form_item">
                ...
                <div class="edit_sign_input_box">
                    ...
                    <input type="text" id="edit_email_2" class="edit_email_input edit_email_input2" value="${subEmail}"
                           disabled>
                ...
                <div class="edit_num">
                    <div class="edit_input_box">
                        <input type="text" id="edit_tel" class="edit_tel_info_input" name="tel" placeholder="전화번호(-)제외"
                               value="">
                        <button type="button" onclick="" class="edit_tel_input_button btnBd edit_confirm_btn">본인인증
                        </button>
                    </div>
